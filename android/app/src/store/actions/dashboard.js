...
const getMyPostsSuccess = () => {
    return { type: actionTypes.GET_MY_POSTS_SUCCESS }
};
const getMyPostsFail = () => {
    return { type: actionTypes.GET_MY_POSTS_FAIL }
};
...
const deletePostFail = (error) => {
    return { type: actionTypes.DELETE_POST_FAIL, error:error }
};
...
const addPostFail = (error) => {
    return { type: actionTypes.ADD_POST_FAIL, error: error }
};
